...
//         expect(
//           components.labelStart.classList.contains(labelHiddenMod)
//         ).toBeFalsy();
...
//     const getRect = (o: { [k in keyof DOMRect]+?: DOMRect[k] } = {}) => ({
//       ...rect,
//       ...o,
//     });
...
//         components.handleStart.setPointerCapture = () => {
//           return;
//         };
...
//         components.handleStart.dispatchEvent(
...
//         expect(parseFloat(newPosition)).toBeGreaterThan(
...
//         expect(parseFloat(newPosition)).toBeLessThan(parseFloat(prevPosition));
//       }
//     });
...
//           root.querySelector('.ui-slider__handle--start')
//         );
